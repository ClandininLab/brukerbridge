...
PRARIEVIEW_VERSION_RIPPER_DICT = {
    ...
    "5.8.64.900": r"C:\Program Files\Prairie 5.8.64.900\Prairie View\Utilities\Image-Block Ripping Utility.exe",
}
            ...
            while True:
                ...
                for session_path, acq_paths in list(in_process_sessions.items()):
                    ...
                    if all(contains_sentinel):
                        ...
                        # windows evidently sometimes throws a permissions
                        # error when the file already exists (and possibly for
                        # other unknown reasons). bill gates is the world's
                        # greatest con man
